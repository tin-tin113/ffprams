...
class BeneficiaryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'rsbsa_number'      => ['nullable', 'required_if:classification,Farmer', 'required_if:classification,Both', 'string', 'max:50'],
            ...
            'fishr_number'     => ['nullable', 'required_if:classification,Fisherfolk', 'required_if:classification,Both', 'string', 'max:50'],
